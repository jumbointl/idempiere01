...
Future<void> showZplPreviewSheet({
  ...
  required String filledReferenceForPdf,
}) async {
    ...
    builder: (ctx) {
      ...
      return SizedBox(
        ...
        child: ZplPreviewSheet(
          ...
          filledReferenceForPdf: filledReferenceForPdf,
...
class ZplPreviewSheet extends StatelessWidget {
  ...
  final String filledReferenceForPdf;
  ...
  const ZplPreviewSheet({
    ...
    required this.filledReferenceForPdf,
  });
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () async {
                      ...
                      await generateAndShareVisualPreviewPdf(
                        context: context,
                        template: template,
                        referenceFilled: filledReferenceForPdf,
                        store: store,
                        dpmm: 8,
                        sizeInInches: '4x6',
                      );
