...
abstract class BarcodeListScreenState<W extends BarcodeListScreen<T>, T>
        ...
        SegmentedButton<BarcodeViewSection>(
          segments: [
            ...
            ButtonSegment(
              ...
              label: Text(tabProductsLabel, style: const TextStyle(fontSize: fontSizeSmall)),
            ),
            ButtonSegment(
  ...
  Widget _buildProductsSection(BuildContext context, WidgetRef ref) {
    final filtered = productBarcodes.where((e) => e.code.trim().isNotEmpty).toList();
  ...
  Widget? getAppBarTitle(BuildContext context, WidgetRef ref) {
    ...
    return Text(documentNo,style: TextStyle(color: Colors.black,fontSize: 18),);
