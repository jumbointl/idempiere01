...
class MovementCard2ForLine extends ConsumerStatefulWidget {
  final IdempiereMovement movement;
  final ProductsScanNotifierForLine productsNotifier ;
  final double width;
  double? height = 150;
  bool? isDarkMode = false;
  MovementCard2ForLine({this.isDarkMode, required this.productsNotifier,
    required this.movement, required this.width, super.key, this.height});


  @override
  ConsumerState<MovementCard2ForLine> createState() => MovementCardForLineState2();
}

class MovementCardForLineState2 extends ConsumerState<MovementCard2ForLine> {
