...
class MovementLineCardForLine extends ConsumerStatefulWidget {
  ...
  MovementLineCardForLine( {required this.width,required this.productsNotifier, required this.movementLine, super.key,
    required this.index, required this.totalLength, this.showLocators});


  @override
  ConsumerState<MovementLineCardForLine> createState() => MovementLineCardForLineState();
}

class MovementLineCardForLineState extends ConsumerState<MovementLineCardForLine> {
