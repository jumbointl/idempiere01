          ...
          WidgetsBinding.instance.addPostFrameCallback((_) async {
            if(data!=null && data.id != null && data.id!>0){
              if(data.docStatus!=null && data.docStatus.id!=null){
                ...
                print('${AppRouter.PAGE_MOVEMENTS_SEARCH}/$id');
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                ref.watch(selectedLocatorFromProvider.notifier).state.value ?? '',
                style: widget.movementStyle,
                overflow: TextOverflow.ellipsis,
              ),
              Text(
                ref.watch(selectedLocatorToProvider.notifier).state.value ?? '',
                style: widget.movementStyle,
                overflow: TextOverflow.ellipsis,
              ),
            ],
