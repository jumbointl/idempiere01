...
class MovementCreateDialog extends ConsumerStatefulWidget {
  ...
  MovementCreateDialog({required this.notifier, required this.width, super.key});


  @override
  ConsumerState<MovementCreateDialog> createState() =>MovementCreateDialogState();
}

class MovementCreateDialogState extends ConsumerState<MovementCreateDialog> {
  bool willPop = false;
      ...
      appBar: AppBar(
        ...
        leading:IconButton(
          ...
          onPressed: () => {
            ...
            isDialogShowed.update((state) => false),
            ...
            print('isdialog showwd ${ref.read(isDialogShowedProvider.notifier).state}'),
