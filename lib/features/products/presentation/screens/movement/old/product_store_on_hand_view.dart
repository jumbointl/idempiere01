...
class ProductStoreOnHandView extends ConsumerStatefulWidget {
  ...
  final int pageIndex = Memory.PAGE_INDEX_CREATE_STORE_ON_HAND;

  ProductStoreOnHandView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => ProductStoreOnHandViewState();


}

class ProductStoreOnHandViewState extends ConsumerState<ProductStoreOnHandView> {
