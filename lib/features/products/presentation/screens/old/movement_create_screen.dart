...
class MovementCreateScreenOld extends ConsumerStatefulWidget {
  ...
  MovementCreateScreenOld({required this.storage, required this.notifier, required this.width, super.key});


  @override
  ConsumerState<MovementCreateScreenOld> createState() =>MovementCreateScreenStateOld();
}

class MovementCreateScreenStateOld extends ConsumerState<MovementCreateScreenOld> {
  ...
  Future<void> getBarcode(BuildContext context, WidgetRef ref) async {
    ...
    if(scanBarcode!=null && scanBarcode!= locatorFrom){
      widget.notifier.findLocatorToByValue(ref,scanBarcode);
    }else {
