...
class ProductUpdateWithPhotoCard extends ConsumerStatefulWidget {
  final IdempiereProduct product;
  final ProductsUpdateNotifier productsNotifier;

  final int actionTypeInt;

  bool testMode = true;

  ProductUpdateWithPhotoCard(
      {required this.productsNotifier, required this.product,
        required this.actionTypeInt, super.key});


  @override
  ConsumerState<ProductUpdateWithPhotoCard> createState() =>
      _ProductDetailWithPhotoCardState();
}

class _ProductDetailWithPhotoCardState extends ConsumerState<ProductUpdateWithPhotoCard> {
  bool testMode = true;
