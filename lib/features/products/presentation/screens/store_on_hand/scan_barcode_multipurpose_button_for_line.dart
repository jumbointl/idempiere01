...
class ScanBarcodeMultipurposeButtonForLine extends ConsumerStatefulWidget {
  final ProductsScanNotifierForLine notifier;

  String scannedData = "";
  ScanBarcodeMultipurposeButtonForLine(this.notifier,{super.key});
  ...
  @override
  ConsumerState<ScanBarcodeMultipurposeButtonForLine> createState() => _ScanBarcodeMultipurposeButtonForLineState();
}


class _ScanBarcodeMultipurposeButtonForLineState extends ConsumerState<ScanBarcodeMultipurposeButtonForLine> {
