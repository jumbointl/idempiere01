...
class UnsortedStorageOnHandCard2 extends ConsumerStatefulWidget {
  ...
  UnsortedStorageOnHandCard2(this.notifier, this.storage, this.index, {required this.width, super.key});


  @override
  ConsumerState<UnsortedStorageOnHandCard2> createState() =>_UnsortedStorageOnHandCardState2();
}

class _UnsortedStorageOnHandCardState2 extends ConsumerState<UnsortedStorageOnHandCard2> {
