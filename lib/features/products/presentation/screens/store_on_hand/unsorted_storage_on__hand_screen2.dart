...
class UnsortedStorageOnHandScreen2 extends ConsumerStatefulWidget {
  ...
  UnsortedStorageOnHandScreen2({required this.index, required this.storage, required this.notifier, required this.width, super.key});


  @override
  ConsumerState<UnsortedStorageOnHandScreen2> createState() =>UnsortedStorageOnHandScreenState2();
}

class UnsortedStorageOnHandScreenState2 extends ConsumerState<UnsortedStorageOnHandScreen2> {
    ...
    return Scaffold(
      appBar: AppBar(
       /* leading:IconButton(
        ...
        title: Text(Messages.MOVEMENT_LINE),
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(ref.read(selectedLocatorFromProvider.notifier).state.value != null
            ...
            child: TextButton(
              ...
              onPressed: () {
                ...
                if (locatorTo.id != null && locatorTo.id>0) {
                  ...
                  widget.notifier.createMovementLine(movementLine);
