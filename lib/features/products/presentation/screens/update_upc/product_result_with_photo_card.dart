...
class ProductResultWithPhotoCard extends ConsumerStatefulWidget {
  ...
  ProductResultWithPhotoCard(
      {required this.product,
        required this.actionTypeInt, super.key});


  @override
  ConsumerState<ProductResultWithPhotoCard> createState() =>
      _ProductDetailWithPhotoCardState();
}

class _ProductDetailWithPhotoCardState extends ConsumerState<ProductResultWithPhotoCard> {
  bool testMode = true;

  @override
  Widget build(BuildContext context) {
    Color backGroundColor = widget.product.id !=null && widget.product.id! >0 ? Colors.green[200]! : Colors.red[200]!;
