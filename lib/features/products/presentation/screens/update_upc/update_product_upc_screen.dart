...
class UpdateProductUpcScreen extends ConsumerStatefulWidget {
  ...
  int pageIndex = Memory.PAGE_INDEX_UPDATE_UPC_SCREEN;
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
        ...
        title: Text(Messages.PRODUCT),
          leading:IconButton(
            ...
            onPressed: () => {
              ...
              context.go(AppRouter.NEW_PAGE_STORAGE_ON_HANGE)
            },
          ),
          actions: [
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: (ref.read(productsHomeCurrentIndexProvider.notifier).state==widget.pageIndex) ?
        ref.watch(usePhoneCameraToScanProvider) ? _buttonScanWithPhone(context, ref):
        ScanBarcodeForUpdateUpcButton(widget.productsNotifier,
          actionTypeInt: widget.actionTypeInt,) : null,
