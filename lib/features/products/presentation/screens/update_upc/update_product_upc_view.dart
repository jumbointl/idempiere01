...
class UpdateProductUpcViewState extends ConsumerState<UpdateProductUpcView> {
        ...
        Container(
          ...
          child: (product.id!=null && product.id! > 0) ?
            _getUpdateUPCCard(context,
               product.copyWith(imageURL: imageUrl,uPC: null)) : NoDataCard(),
          ),
        ],
      ),
    );
  ...
  Future<void> showConfirmationDialog(BuildContext context) async {
    ...
    controller.text = ref.read(newUPCToUpdateProvider);
    bool stateActual = ref.watch(usePhoneCameraToScanProvider);
    ...
    AwesomeDialog(
        ...
        btnOkOnPress: () {
          ref.read(usePhoneCameraToScanProvider.notifier).state = stateActual;
