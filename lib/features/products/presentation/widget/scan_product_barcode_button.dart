...
class ScanProductBarcodeButton extends ConsumerStatefulWidget {
  ...
  String scannedData = "";
  ScanProductBarcodeButton({required this.notifier,  required this.pageIndex, required this.actionTypeInt, super.key});
    ...
    if (data.isNotEmpty) {
      switch(actionTypeInt){
        ...
        case Memory.ACTION_GET_LOCATOR_TO_VALUE:
          print('-------------------------------Memory.ACTION_GET_LOCATOR_TO_VALUE ${Memory.ACTION_GET_LOCATOR_TO_VALUE}');
...
class ScanProductBarcodeButtonState extends ConsumerState<ScanProductBarcodeButton> {
  ...
  Widget build(BuildContext context) {
    widget.notifier = ref.watch(scanHandleNotifierProvider.notifier);
