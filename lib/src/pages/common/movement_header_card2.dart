...
class MovementHeaderCard2 extends ConsumerStatefulWidget {
  Color bgColor;
  late IdempiereMovement? movement;
  double height = 200.0;
  double width = double.infinity;
  MovementHeadersView headersView;
  MovementHeaderCard2({
    super.key,
    ...
    required this.width,
    this.movement,
    required this.headersView,
  });

  @override
  ConsumerState<MovementHeaderCard2> createState() => MovementHeaderCardState2();
}


class MovementHeaderCardState2 extends ConsumerState<MovementHeaderCard2> {
  @override
        ...
        child: Container(
          ...
          GestureDetector(
            onTap: (){
              ...
              widget.headersView.confirmButtonPressed(context, ref, movement.id.toString());
            },
            child: Container(
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: TextButton(
                        onPressed: () {
                          widget.headersView.lastButtonPressed(context, ref, Memory.lastSearch);
                        },
                  ...
                  Expanded(
                    child: TextButton(
                      onPressed: () {
                        widget.headersView.findButtonPressed(context, ref, '');
                  ...
                  Expanded(
                    child: TextButton(
                      onPressed: () {
                        widget.headersView.newButtonPressed(context, ref, '');
                      },
                      style: TextButton.styleFrom(
                        backgroundColor: themeColorPrimary,
                        //padding: EdgeInsets.symmetric(horizontal: 12.w, vertical: 4.h),
